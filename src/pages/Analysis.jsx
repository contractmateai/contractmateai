...
const Analysis = () => {
  // TODO: Move any legacy JS logic into React hooks if needed
  return (
    <>
      <Topbar />
      <main className="analysis-main" style={{ minHeight: "100vh", background: "var(--bg-dark)" }}>
        <div className="doc-title" style={{ marginTop: 32, textAlign: "center" }}>
          <span className="label" id="uiTitleLabel">Title:</span>
          <span className="value" id="uiTitleValue">—</span>
        </div>
        <div className="analysis-grid" style={{ display: "flex", flexWrap: "wrap", justifyContent: "center", gap: 32, margin: "32px auto", maxWidth: 1400 }}>
          <div className="left" style={{ flex: "1 1 340px", minWidth: 320, maxWidth: 420 }}>
          ...
          <div className="right" style={{ flex: "1 1 340px", minWidth: 320, maxWidth: 420 }}>
        ...
        <div className="download-wrap" id="dlWrap" style={{ textAlign: "center", margin: "32px auto" }}>
          <button className="download" id="downloadBtn">Download Report</button>
          <form id="emailInline" className="email-inline" noValidate style={{ marginTop: 16 }}>
